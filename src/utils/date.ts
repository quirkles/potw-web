...
export function getDateString(date?: string | number | Date): DateString {
    ...
    if (!isDateString(dateString)) {
        throw new Error("Invalid date string generated by getDateString: " + dateString);
    }
    return dateString;
};

export function addTo(quantity: number, unit: "day" | "month" | "year", date: DateString): DateString {
...
export function subtractFrom(quantity: number, unit: "day" | "month" | "year", date: DateString): DateString {
    return addTo(-quantity, unit, date);
}

export function getDifferenceInDays(startDate: DateString, endDate: DateString, unit: "day" | "month" | "year"): number {
